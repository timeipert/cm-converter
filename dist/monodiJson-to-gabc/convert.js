...
function getFiles(dir) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, readdir(dir)];
                case 1:
                    subdirs = _a.sent();
                    return [4, Promise.all(subdirs.map(function (subdir) { return __awaiter(_this, void 0, void 0, function () {
                            var res;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        return [4, stat(res)];
                                    case 1: return [2, (_a.sent()).isDirectory() ? getFiles(res) : res];
                                }
                            });
                        }); }))];
                case 2:
                    files = _a.sent();
                    return [2, files.reduce(function (a, f) { return a.concat(f); }, [])];
            }
        });
    });
}
